...
//	}
	...
	public void testArgumentsValidDebian() {
		...
		String[] arguments = "-b -c gpl3 -d Desc no. 1 -C i -D Desc no. 2 -s admin -e a.b@c.d -f a:b c:d -n A B -p some-name -V 0.1 -w http://u.rl".split(" ");
		boolean argumentsCorrectlyParsed = Arguments
				.parseInputArguments(arguments);
		assertTrue(argumentsCorrectlyParsed);
	}
	...
	/**
	 * Ensure valid arguments are successfully processed in a Red Hat-based environment.
	 */
	@Test
	public void testArgumentsValidRedHat() {
		...
		String[] arguments = "-b -c gpl3 -d Desc no. 1 -C i -D Desc no. 2 -e a.b@c.d -f a:b c:d -n A B -p some-name -V 0.1-1 -w http://u.rl".split(" ");
		boolean argumentsCorrectlyParsed = Arguments
				.parseInputArguments(arguments);
		assertTrue(argumentsCorrectlyParsed);
	}
