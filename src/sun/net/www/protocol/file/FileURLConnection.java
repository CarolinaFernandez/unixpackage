...
public class FileURLConnection extends URLConnection {
	...
	/**
	 * Copied from original due to restrictions on this library in some systems
	 * and due to some incompatibilities in some UNIX distributions
	 */
		...
		if (!connected) {
			try {
				...
				if (isDirectory) {
					...
					// boolean meteredInput =
					// ProgressMonitor.getDefault().shouldMeterInput(url,
					// "GET");
					// if (meteredInput) {
					// ProgressSource pi = new ProgressSource(url, "GET", (int)
					// file.length());
